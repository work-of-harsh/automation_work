...
public class Dropdown {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("ul li[class='ui-menu-item'] a")));
		List<WebElement> countries = driver.findElements(By.cssSelector("ul li[class='ui-menu-item'] a"));
		Thread.sleep(3000); 
